...
module.exports = function(app) {
  ...
  // Mock routes for use with integration tests
  if (app.get('env') === 'testing' || app.get('mockAuth')) {
    app.get('/mockcheckin', ensureAuthenticated, setCSRFtoken, function(req, res) { 
    ...
    app.get('/mock/login', passport.authenticate('mock', { successRedirect: '/donothing',
                                                         failureRedirect: '#/signinwithtwitter' }));
  }
