...
var client = redis.createClient(credentials[env].redis.port, credentials[env].redis.localhost);
// Switch to the database specfically for fetching
client.select(credentials[env].redis.dbs.fetching, function() {}); // I don't think we need this callback, 
